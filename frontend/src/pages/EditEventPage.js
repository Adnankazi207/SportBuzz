...
const EditEventPage = () => {
    ...
    const fetchEventAndLists = async () => {
      try {
        const [eventRes, catRes, cityRes, areaRes] = await Promise.all([
          axios.get(`https://sportbuzz.onrender.com/api/events/${id}`, {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('https://sportbuzz.onrender.com/api/public/sport-categories', {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('https://sportbuzz.onrender.com/api/public/cities', {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get('https://sportbuzz.onrender.com/api/public/areas', {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ]);
  ...
  const handleSubmit = async () => {
    try {
      await axios.put(
        `https://sportbuzz.onrender.com/api/events/${id}`,
        form,
        {
          headers: {
