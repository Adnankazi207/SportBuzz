...
const AdminAreas = () => {
  ...
  const fetchCities = async () => {
    try {
      const res = await axios.get('https://sportbuzz.onrender.com/api/admin/cities', {
  ...
  const fetchAreas = async () => {
    try {
      const res = await axios.get('https://sportbuzz.onrender.com/api/admin/areas', {
        headers: { Authorization: `Bearer ${token}` },
      });
      setAreas(res.data);
    } catch (err) {
  ...
  const handleAddOrEdit = async () => {
    ...
    try {
      if (editingId) {
        await axios.put(
          `https://sportbuzz.onrender.com/api/admin/areas/${editingId}`,
        ...
        await axios.post(
          'https://sportbuzz.onrender.com/api/admin/areas',
          { name: areaName, city: selectedCity },
          { headers: { Authorization: `Bearer ${token}` } }
        );
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://sportbuzz.onrender.com/api/admin/areas/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
